...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr height="50">
    <td align="center"><b>Başarılı! Yeni Adresiniz eklenmiştir.</b></td>
    </tr>
    <tr>
        <td class="SonucSayfalari" align="center">Hesabım > Adresler sayfasına dönemk için lütfen <a href="index.php?SK=58"><b>buraya tıklayınız.</b></a></td>
    </tr>
</table>
<?php
}else{
