...
$Sayfa[81] = "hesabimfavorilersilhata.php";
        $Sayfa[82] = "urundetay.php";

        $Sayfa[83] = "kadinurunleri.php";
        $Sayfa[84] = "kadinurunleriaramasonuc.php";

        $Sayfa[85] = "erkekurunleri.php";
        $Sayfa[86] = "erkekurunleriaramasonuc.php";

        $Sayfa[87] = "digerurunler.php";
        $Sayfa[88] = "digerurunleraramasonuc.php";
