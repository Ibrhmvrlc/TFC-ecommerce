...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td align="center">Lütfen tekrar deneyiniz. Yeni Adres eklerken gerekli alanları boş bırakmayınız.</td>
    </tr>
    <tr>
        <td class="SonucSayfalari" align="center">Hesabım > Adresler > Yeni Adres Ekle sayfasına dönmek için Lütfen <a href="index.php?SK=70"><b>buraya tıklayınız.</b></a></td>
    </tr>
</table>
<?php
}else{
