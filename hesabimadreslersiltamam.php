...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr height="50">
    <td align="center"><b>Silme işlemi Başarılı!</b></td>
    </tr>
    <tr>
        <td align="center">Hesabım > Adresler sayfasına <b>Yönlendiriliyorsunuz</b>, lütfen bekleyiniz.</td>
    </tr>
    <tr>
        <td class="SonucSayfalari" align="center">Beklememek için <a href="index.php?SK=58"><b>lütfen tıklayınız.</b></a></td>
    </tr>
</table>
<?php
header("Refresh: 2; url=index.php?SK=58");
}else{
