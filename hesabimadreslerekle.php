        ...
        <td width="500" valign="top">
            <form action="index.php?SK=71" method="post">
                <table width="500" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr height="40">
                        <td style="color:#FF9900;"><h3>Hesabım > Adresler > Yeni Adres Ekle</h3></td>
                    </tr>
                    <tr height="30">
                        <td valign="top" style="border-bottom: 1px solid #CCCCCC;">Lütfen ekleyeceğiniz adresle ilgili gerekli alanları doldurunuz.</td>
                    </tr>
                    <tr height="30">
                    ...
                    <tr height="30">
                        <td valign="top"  align="left"><input type="text" name="Ulke" class="InputAlanlari"></td>
                    </tr>
                    <tr height="40">
                        <td colspan="2" align="center"><input type="submit" value="Yeni Adres Ekle" class="YesilButon"></td>
                    </tr>
                </table>
            </form>
        </td>
